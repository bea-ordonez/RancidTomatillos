describe('', () => {
  beforeEach(() => {
    ...
    cy.intercept('GET', 'https://rancid-tomatillos.herokuapp.com/api/v2/movies/724495', { fixture: 'single-movie-twk.json' });
    cy.intercept('GET', 'https://rancid-tomatillos.herokuapp.com/api/v2/movies/724495/videos', { fixture: 'single-movie-videos-twk.json' });
  });
